...
config.presets = {
  ["default"] = {
    ...
    regular_patch_fade_in_distance_start = 150,  -- Don't have any non-starting patches spawn until 150, ramp up between 150 and 300
    ...
    starting_resource_placement_radius = 70,  -- 120
