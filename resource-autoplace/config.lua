...
config.presets = {
  ["default"] = {
    ...
    regular_patch_fade_in_distance = 300,  -- 300
    regular_patch_fade_in_distance_start = 130,  -- Don't have any non-starting patches spawn until 150, ramp up between 150 and 600
    ...
    starting_resource_placement_radius = 80,  -- 120
