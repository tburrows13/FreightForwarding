...
config.presets = {
  ["default"] = {
    ...
    regular_patch_fade_in_distance_start = 1200,  -- Don't have any non-starting patches spawn until this, ramp up between this and regular_patch_fade_in_distance
    regular_rq_factor_coefficient = 1,
    regular_rq_factor_multiplier = 1,
    richness_post_multiplier = 1,
    seed = 100,
    size_multiplier_coefficient = 1,
    starting_amount = 80000,  -- 40000
